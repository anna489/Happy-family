    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  container mx-auto py-20 sticky">
      <div className="justify-center">
        <ul>
          <li>
            <a href="/">
              <img src="./image/logo.png" className=" h-30 w-40 " />
            </a>
          </li>
        </ul>
      </div>
      <div className="hidden  md:flex gap-12 items-center justify-self-end lg:justify-center ">
        {navigations.map((navigation, i) => (
          <Link
            className={`flex text-gray-500 text-[25px] font-medium text-xl ${
      ...
      <div className=" hidden md:flex gap-12 items-center justify-self-end lg:justify-center ">
        <ul className="text-white px-6 py-2 font-medium bg-[#D03737] rounded border">
          <li>
